                                        ...
                                        <tbody>
                                            <tr>
                                                <td id="m_-8663709442295350112header_wrapper" style="padding:20px 32px 0;display:block">
                                                    <h1 style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:32px;letter-spacing:-1px;line-height:120%;margin:0;color:#111;background-color:inherit;text-align:left;font-weight:300;text-transform:uppercase" bgcolor="inherit">Thank you for your order</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                                    ...
                                                                    <div id="m_-8663709442295350112body_content_inner" style="color:#414141;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:16px;line-height:150%;text-align:left" align="left">
                                                                        ...
                                                                        <div style="padding-bottom:24px">
                                                                            <p style="margin:0 0 16px">
                                                                                Hi <?= esc_html($customer_name) ?>,<br><span>Your Payment Status is <strong>Processing</strong></span></p>
                                                                            ...
                                                                            <table class="m_-8663709442295350112email-order-details" cellspacing="0" cellpadding="6" border="0" style="color:#414141;border:0;vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;width:100%" width="100%">
                                                                                ...
                                                                                <tfoot>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="color:#414141;border:0;vertical-align:middle;text-align:right;font-weight:normal;padding-bottom:5px;padding-top:5px;padding-right:0;padding:8px 12px;border-bottom:none" align="right">Processing</td>
                                                                                    </tr>
                                                                                </tfoot>
                                                                            </table>
                                                                        </div>
