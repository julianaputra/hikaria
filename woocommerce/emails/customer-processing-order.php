...
if ( $order instanceof WC_Order ) {
	...
	echo '<br><span>Your Payment Status is <strong>' . esc_html( $status_label ) . '</strong></span>';
}
?>
</p>
...
if ( $additional_content ) {
	echo $email_improvements_enabled ? '<table border="0" cellpadding="0" cellspacing="0" width="50%"><tr><td class="email-additional-content">' : '';
